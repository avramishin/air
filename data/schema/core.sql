...
-- Дамп структуры для таблица air.acl_objects
...
-- Дамп структуры для таблица air.acl_roles
...
-- Экспортируемые данные не выделены.
-- Дамп структуры для таблица air.acl_roles_objects
...
-- Экспортируемые данные не выделены.
-- Дамп структуры для таблица air.acl_users_roles
